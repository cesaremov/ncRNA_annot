...
sRNA_annotaiton pipeline first identifies sRNA producing loci based on homology.

To run homology annotation, you must type (C. elegans sRNA producing loci annotation example):
